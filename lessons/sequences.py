...
# An example of a tupe without type aliasing
...
# Which means we cannot reassign itesm, nor append, nor pop, etc
# goat[0] = "LBJ"

# We can "invent" our own type with a type alias
Player = tuple[str, int]

# Once we've aliased a typem we can create variables of that type
...
# We can have differenct steps for more control
odds_to_99: range = range(1, 100, 2)
for i in odds_to_99:
    print(i)


names: list[str] = ["Kis", "Alyssa", "Michael", "Lebron"]
